    ...
    // cycle through the faces and copy the vertex info into the final vertex/index buffers.
    {
        ...
        for( int f=0; f<facecount; f++ )
        {
            ...
            for( int v=0; v<numvertsinface; v++ )
            {
                ...
                verts[vertindex].pos.x = VertexPositions[vertposindex].x * scale.x;
                verts[vertindex].pos.y = VertexPositions[vertposindex].y * scale.y;
                verts[vertindex].pos.z = VertexPositions[vertposindex].z * scale.z;
                ...
                {
                    //verts[vertindex].normal.x = VertexNormals[vertnormalindex].x;
                    //verts[vertindex].normal.y = VertexNormals[vertnormalindex].y;
                    //verts[vertindex].normal.z = VertexNormals[vertnormalindex].z;
                }

                verts[vertindex].color.r = rand()%255;
                verts[vertindex].color.g = rand()%255;
                verts[vertindex].color.b = rand()%255;
                verts[vertindex].color.a = 255;
            }
