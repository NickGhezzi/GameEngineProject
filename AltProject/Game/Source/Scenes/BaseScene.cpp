...
void BaseScene::Draw()
{
    ...
    //static_cast<fw::PhysicsWorld2D*>(m_pPhysicsWorld)->DrawDebugData(m_pCamera->GetView(), m_pCamera->GetProj());
}
...
GameObject* BaseScene::GetGameObjectByName(std::string name)
{
    for( int i=0; i<m_Objects.size(); i++ )
    {
