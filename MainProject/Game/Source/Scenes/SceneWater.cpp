...
void SceneWater::Init()
{
    ...
    m_pWater = new Player(this, m_pResources->GetMesh("Plane"), m_pResources->GetMaterial("Water"), vec3(1, 1, 1), vec3(0, 0, 0), vec3(-3, -1, 0), 0, m_pGame->m_pController);
    m_pWater->CreateBody(false);
